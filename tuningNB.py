...
spark = SparkSession.builder.appName("TuningNB1").getOrCreate()
...
# Hyperparameters Tunning: Cross Validation

nb = NaiveBayes(labelCol='isFraud',featuresCol='my_features')
...
params = ParamGridBuilder()\
            .addGrid(nb.smoothing, [int(x) for x in np.linspace(start=0, stop=5, num=3)])\
            .build()
