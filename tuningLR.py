...
params = ParamGridBuilder()\
            .addGrid(lr.regParam, [int(x) for x in np.linspace(start=0, stop=1, num=3)])\
            .addGrid(lr.elasticNetParam,[int(x) for x in np.linspace(start=0, stop=1, num=3)])\
            .build()
